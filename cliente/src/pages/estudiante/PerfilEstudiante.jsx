...
const PerfilEstudiante = () => {
  ...
  const isValidDocumento = (documento) => {
    return /^[0-9]{7,10}$/.test(documento);
  };
  ...
  const handleBlur = (field) => {
    ...
    if (field === 'documento' && perfil.documento) {
      if (!isValidDocumento(perfil.documento)) {
        newErrors.documento = 'Ingrese un documento válido (solo números, 7-10 dígitos)';
      } else {
  ...
  const validatePerfilForm = () => {
    ...
    if (perfil.documento && !isValidDocumento(perfil.documento)) {
      newErrors.documento = 'Ingrese un documento válido (solo números, 7-10 dígitos)';
    }
